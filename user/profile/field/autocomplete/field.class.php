...
class profile_field_autocomplete extends profile_field_base {
     ...
     * Constructor method.
     *
     * Pulls out the options for the autocomplete from the database and sets the the corresponding key for the data if it exists.
     *
     * @param int $fieldid
     * @param int $userid
     */
    public function __construct($fieldid = 0, $userid = 0) {
        ...
        // Param 1 for autocomplete type is the options.
     ...
     */
    public function profile_field_autocomplete($fieldid=0, $userid=0) {
     ...
     *
     * @param string $value one of the values in autocomplete options.
     * @return int options key for the autocomplete
     */
