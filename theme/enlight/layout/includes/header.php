    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div id="sgkk" class="container-fluid">
          ...
          <?php } else {
          	echo theme_enlight_get_exta_logoes_url(); 
          }?>
...
?>
              ...
              <a href="<?php echo $CFG->wwwroot; /*echo new moodle_url('/course/index.php');*/ ?>" ><?php echo get_string('courses'); ?>
	...
	<?php
       ...
       $supporturl= theme_enlight_get_setting('supporturl');
        if (!empty($abouturl)){
 	 	...
 	 	if (!empty($supporturl)){
	  		echo '<li><a href="'.$supporturl.'" target="support" >'.get_string('support','theme_enlight').'</a></li>'."\n";
	  	}	
	 ?>
            </ul>
          </div>
