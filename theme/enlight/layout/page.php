...
<html <?php echo $OUTPUT->htmlattributes(); ?>>
    ...
    <body <?php echo $OUTPUT->body_attributes($bodyclasses); ?>>
        ...
        <div id="page" class="lesson-page">
            ...
            <div id="page-content" class="container-fluid lesson">
                <div class="row-fluid">
                    <?php 
                    $strClassContent='span8';
                    if ($currentSection==0){
                        $strClassContent='span10';  
                    }
                    ?>
                    ...
                    <div id="<?php echo $regionbsid ?>" class="<?php echo $strClassContent?> lesson-content">
                        <section id="region-main">
                           ...
                           // if ($intFirstPageId!=$PAGE->cm->id){
                                require_once(dirname(__FILE__) . '/includes/strategics.php');
                           // }
                            ?>
                        </section>
                    </div>
        ...
        $('.lesson-list .scroller').scrollbar();
