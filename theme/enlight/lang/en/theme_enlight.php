...
/**
 * Strings for component 'theme_enlight', language 'en'
 *
...
$string['abouturldesc'] = 'Link to site that  describe the project';
$string['supporturldesc'] = 'Link to support site ';
$string['Categories'] = 'Categories';
$string['partnerheaderDesc']='Partner Header desc';
$string['courseentery']='Courses';
$string['enter']='enter';
$string['hello']='Hi';
$string['start-study']='התחל ללמוד';
$string['course-select']='בחרו קורס בהתאם לרמתכם';
$string['mail-placeholder']='דואר אלקטרוני';
$string['registration']='הרשמה';
$string['create-account']='Create an account';
