About Enlight Moodle theme
=========================
This is Responsive Bootstrapbase Moodle Theme
* package   Moodle Enlight Theme
...
Enlight theme - Installation steps
================================

1) On your download pacakge, you will find theme_enlight.zip

2) Unzip - theme_enlight.zip, you will get folder 'enlight'

3) Copy folder 'enlight' and put into theme folder of your moodle system
...
8) By clicking "Continue" button on success page , you will get options to change the enlight theme settings.
   You can modify the settings later too :-)


Steps to set enlight theme as default theme for your moodle system
==================================================================
...
5) Then click "Use theme" button on "Enlight theme"
...
For more details please visit our online documentation http://www.lmsthemes.com/doc/enlightv10/.
